...
\vspace{1cm}
\textbf{Question:Now assume that we decide to implement an IFFT with size 4096, and redo the previous two points.}
\vspace{0.5cm}

\textbf{For the QPSK constellation:}

\[
R = \frac{N \times \text{Bits}_s}{T_{OFDM}} = \frac{4096 \times 2}{56 \times 10^{-6}} \approx \textbf{146.28 Mbits/s}.
\]

\textbf{For the 16-QAM constellation:}

\[
R = \frac{N \times \text{Bits}_s}{T_{OFDM}} = \frac{(4096 - 100) \times 2}{56 \times 10^{-6}} \approx \textbf{285.42 Mbits/s}.
\]