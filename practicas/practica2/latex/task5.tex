...
The correct \texttt{H} parameter is the frequency-domain representation of the multipath channel. It is computed as the $N$-point DFT of the zero-padded discrete-time channel impulse response:

\[
\texttt{H}[k] = \text{FFT}\{\tilde{h}[n]\} \quad k = 0, 1, \ldots, N-1
\]
