...
Points near the origin occur because zero-padding and nulled subcarriers propagate through the OFDM chain unchanged. When the input data length is not a multiple of the number of active subcarriers, zeros are appended to complete the last OFDM block. These zero-valued subcarriers appear as a small cluster around (0,0) in the constellation, but they do not correspond to transmitted data symbols.