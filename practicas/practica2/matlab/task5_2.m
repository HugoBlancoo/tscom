...
% The signal z has length: length(x) + length(h_tilde_discrete) - 1
fprintf('Length of transmitted signal x: %d samples\n', length(x));
fprintf('Length of channel h_tilde: %d samples\n', length(h_tilde_discrete));
fprintf('Length of received signal z: %d samples\n', length(z));
