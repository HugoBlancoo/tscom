...
In the plot of the Figure \label{fig:kalman_sigma} we can see how the curve drop to approximately 2 at $n = 200$
...
\textbf{Question: Repeat your simulations after changing $\sigma_\ell$ to 50 cm. Repeat again for $\sigma_\ell = 5$ cm. Comment on your results.}
