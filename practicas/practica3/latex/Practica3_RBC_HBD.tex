...
\hypersetup{
    ...
    pdfsubject={Práctica 3 - Kalman Filtering },
}

% Configuración de encabezado y pie de página
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\footnotesize Práctica 3}
\fancyhead[R]{\footnotesize Kalman Filtering}
\fancyfoot[C]{\thepage}
\renewcommand{\headrulewidth}{0.4pt}
\renewcommand{\footrulewidth}{0.4pt}

% Comando pa resaltar preguntas
\newcommand{\question}[1]{\textcolor{blue!60!black}{\textbf{#1}}}
...
\section{Task 1}
\input{task1}
ACTUALIZAR LA CAPTURA DE LA Q1 Y Q2
\vspace{0.5cm}
\section{Task 2}
\input{task2}
