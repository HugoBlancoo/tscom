...
\begin{itemize}
    \item The flow uncertainty decreases more slowly than the level uncertainty because flow is not directly observed—it must be inferred from the rate of change of level measurements.
