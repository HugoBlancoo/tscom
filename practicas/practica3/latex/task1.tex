The detailed derivations and step-by-step justifications for all questions in this section can be found in Appendix~\ref{app:handwritten}.
...
\begin{equation*}
  ...
  \bm e = \begin{bmatrix} e_0 \\ e_1 \\ \vdots \\ e_{n-1} \end{bmatrix}
\end{equation*}
