...
\textbf{CRITICAL FAILURE:} The estimate (red line, left panel bottom) diverges dramatically. In the first few iterations, the filter receives mostly pure noise (failed measurements). Without knowing this, it interprets the noise as information about the state and updates accordingly. The estimate jumps erratically downward to approximately 50--100 cm (far from the true 340 cm) by sample $n \approx 10$ and remains stuck there.
