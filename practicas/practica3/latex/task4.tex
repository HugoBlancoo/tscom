...
We simulate the Kalman filter with a working failure indicator~\ref{app:kalman_dc_errs}. Simulation parameters: $\mu_\ell = 250$ cm, $\sigma_\ell = 11$ cm, $\ell_{\text{true}} = 340$ cm, $\sigma_v = 25$ mbar, $c_h = 0.85652$ mbar/cm.
