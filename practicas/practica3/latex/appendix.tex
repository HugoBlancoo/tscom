...
\begin{lstlisting}[language=Matlab]
    ...
    for n = 2:N+2
        ...
        Kgain = cov_pred*cst_p / (cst_p^2*cov_pred + var_v);
...
\subsection{Task 4}
\subsubsection{kalman\_dc\_errs.m}
\label{app:kalman_dc_errs}
...
\subsection{Task 5}
\subsubsection{kalman\_flow.m}
\label{app:kalman_flow}
...
\subsection{Task 6}
\subsubsection{kalman\_flow2.m}
\label{app:kalman_flow2}
...
\subsubsection{task6\_4.m}

This script block is added to the previous one.
...
\begin{lstlisting}[language=Matlab]
    ...
    semilogy(time_vec, sqrt(Sigma_hist_q_one), 'r--', 'LineWidth', 2.5, ...
        'DisplayName', 'Task 5 (1 sensor)');
    xlabel('Time (minutes)', 'FontSize', 11);
    ylabel('Std Dev (cm^3/s)', 'FontSize', 11);
